...
public struct GridView: View {
    ...
    var sizeFactor: CGFloat {
        cos(fractionComplete)
    }
    
    var blurFactor: CGFloat {
        fractionComplete < 0.5 ? (fractionComplete * 10.0) : (fractionComplete / 10.0)
    }
    
    var rotateFactor: CGFloat {
        360 * fractionComplete
    }
    ...
    @State var axis: (CGFloat, CGFloat, CGFloat) = (CGFloat.random(in: 0.0 ... 15.0), CGFloat.random(in: 0.0 ... 15.0), CGFloat.random(in: 0.0 ... 15.0))
            ...
            GeometryReader { g in
                self.lines(for: self.viewStore, g: g)
                    ...
                    .rotation3DEffect(Angle(
                        degrees: Double(self.rotateFactor)),
                                      axis: self.axis,
                                      anchor: .bottom,
                                      anchorZ: 0.00,
